...
console.log("Task 1b", createMenuItem("steak", 18, "dinner"))
console.log("Task 1b", createMenuItem("Breakfast Burrito", 8, "breakfast"))
...
console.log("Task 7", getReviewByIndex(reviews))
